...
class TwoWayEnv(AbstractEnv):
    ...
    def _make_road(self, length=800):
        ...
        shift = -2
        # Lanes
        net.add_lane("a", "b", StraightLane([0, shift], [length, shift],
                                            line_types=(LineType.CONTINUOUS_LINE, LineType.STRIPED)))
        net.add_lane("a", "b", StraightLane([0, StraightLane.DEFAULT_WIDTH + shift], [length, StraightLane.DEFAULT_WIDTH + shift],
                                            line_types=(LineType.NONE, LineType.CONTINUOUS_LINE)))
        net.add_lane("b", "a", StraightLane([length, shift], [0, shift],
